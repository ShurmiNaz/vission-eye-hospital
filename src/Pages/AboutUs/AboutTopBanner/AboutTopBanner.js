...
const AboutTopBanner = () => {
     return (
          <main>
               ...
               <section>
                    <section className='bg-yellow-300 h-40 flex items-center justify-evenly flex-wrap' >
