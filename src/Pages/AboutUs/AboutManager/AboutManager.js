...
const AboutManager = () => {
     return (
          <div>
               <div className=' py-12 px-16 mt-8  bg-slate-50'>
                    <div className='grid grid-cols-5 '>
                         <div className='  flex justify-end col-span-2 '><img className='w-full' src={aboutsaimon} alt="managerpic" /></div>
                         <div className='space-y-4 col-span-3 text-white bg-gradient-to-r from-yellow-600 to-amber-700 p-20 '>
               ...
               <div className=' py-12 px-16   bg-slate-50'>
                    <div className='grid grid-cols-5 '>

                         <div className='space-y-4 col-span-3 text-white bg-gradient-to-r from-amber-700 to-yellow-700 p-20 '>
                         ...
                         <div className='  flex justify-end col-span-2 '><img className='w-full' src={zakia} alt="managerpic" /></div>
                    </div>
               </div>
          </div>
     );
