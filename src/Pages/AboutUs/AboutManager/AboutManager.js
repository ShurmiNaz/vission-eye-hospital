               ...
               <div className=' sm:py-12 sm:px-16 sm:mt-8  bg-slate-50'>
                    <div className='sm:grid sm:grid-cols-5 '>
                         ...
                         <div className='p-3 m-2  sm:m-0 space-y-4 col-span-3 text-white bg-gradient-to-r from-yellow-600 to-amber-700 sm:p-20 '>
                              ...
                              <p className='text-xl text-justify leading-loose '>Our cherished International Patients coordinator M.K.A. Saimon has helped us deliver the services at the highest level of quality control. From the patient's initial query to the end of the service, he remained a point of contact for all examines and answers to questions from users and facilitators. He plays a significant part in the conversion process, closely collaborating with the info line, people, facilitators, and medical professionals as well as coordinates and distributes information on transfers, accommodations, travel, and visas. </p>
                         </div>
                    </div>
               </div>
               ...
               <div className=' sm:py-12 sm:px-16 sm:mt-8   bg-slate-50'>
                    <div className='flex flex-col-reverse sm:grid sm:grid-cols-5 '>
                         ...
                         <div className='p-3 m-2  sm:m-0 space-y-4 col-span-3 text-white bg-gradient-to-r from-amber-700 to-yellow-700 sm:p-20 '>
                              ...
                              <h3 className='text-2xl font-semibold'>Dr. Zakia Farhana</h3>
